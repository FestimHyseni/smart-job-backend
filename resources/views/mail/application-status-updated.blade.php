...
<title>Statusi i aplikimit u përditësua</title>
</head>
...
Statusi i aplikimit tuaj për pozitën <strong>{{ $jobTitle }}</strong> në <strong>{{ $companyName }}</strong> ndryshoi në:
</p>

<table role="presentation" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
<tr>
<td style="border-radius:999px; background-color:{{ $accentColor }}1a; padding:8px 18px;">
<span style="font-size:14px; font-weight:700; color:{{ $accentColor }};">{{ $statusLabel }}</span>
</td>
</tr>
</table>
